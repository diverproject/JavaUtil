 ...
 *
 * <p>Para esse tipo de mapeamento será considerado as chaves o primeiro caracter.
 * Sendo assim, existem 256 chaves possíveis para todos os elementos serem encontrados.
 * Utiliza um pouco mais de memória, se não for muito usado não é recomendado.</p>
 *
 * @author Andrew
 *
...
public class StringMap<E> extends AbstractCollection<E> implements Map<String, E>
{
	/**
