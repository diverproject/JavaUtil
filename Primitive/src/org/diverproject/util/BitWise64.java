...
public class BitWise64
{
	...
	public BitWise64(String... propertieNames)
	{
	...
	public boolean is(long propertie)
	{
	...
	public void set(long propertie)
	{
		value |= propertie;
	}
	...
	public void unset(long propertie)
	{
	...
	public String toStringProperties()
	{
		...
		if (propertieNames.length == 0 || propertieNames == null)
			str.append(Long.toBinaryString(value));

		else
		{
			String binary = Long.toString(value);
	...
	public static boolean is(long value, long propertie)
	{
		return (value & propertie) == propertie;
	}
	...
	public static long unset(long value, long propertie)
	{
