...
public class BitWise8
{
	...
	public BitWise8(String... propertieNames)
	{
	...
	public static boolean is(byte value, int propertie)
	{
		return (value & propertie) == propertie;
	}
	...
	public static byte set(byte value, int propertie)
	{
	...
	public static byte unset(byte value, int propertie)
	{
