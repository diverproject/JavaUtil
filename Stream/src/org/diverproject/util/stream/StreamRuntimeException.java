...
public class StreamRuntimeException extends UtilRuntimeException
{
	/**
	...
	public StreamRuntimeException(String format, Object... args)
	{
		super(format, args);
	}
	...
	public StreamRuntimeException(Exception e, String format, Object... args)
	{
		super(e, format, args);
	}
}
